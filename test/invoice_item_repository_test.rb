...
class InvoiceItemRepositoryTest < MiniTest::Test
  def setup
    @invoice_item_repo = InvoiceItemRepository.new("invoice_items.csv", InvoiceItem)
  end
  ...
  def test_it_finds_by_id 
    assert_equal "29", @invoice_item_repo.find_by_id("29")[:id]
    assert_equal "35", @invoice_item_repo.find_by_id("35")[:id]
    assert_equal "76", @invoice_item_repo.find_by_id("76")[:id]
  end
end
