...
class TransactionRepositoryTest < MiniTest::Test
  ...
  def test_it_finds_by_id
    assert_equal "29", @transaction_repo.find_one_by_id("29").info[:id]
    assert_equal "35", @transaction_repo.find_one_by_id("35").info[:id]
    assert_equal "76", @transaction_repo.find_one_by_id("76").info[:id]
  end
end
